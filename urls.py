...
urlpatterns = patterns('',
                       ...
                       url(r'^edu/$', TemplateView.as_view(template_name='edu.html'), name='edu'),
                       url(r'^maritimeboundaries/$', TemplateView.as_view(template_name='maritimeboundaries.html'), name='maritimeboundaries'),
